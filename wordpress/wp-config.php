...
// EQAR settings
define('DEQAR_WEBAPI_BASE', getenv_docker('DEQAR_WEBAPI_BASE', 'https://backend.sandbox.deqar.eu/webapi/v2/browse/'));
define('DEQAR_CONNECTAPI_BASE', getenv_docker('DEQAR_CONNECTAPI_BASE', 'https://backend.sandbox.deqar.eu/connectapi/v1/'));
define('DEQAR_MEILIAPI_BASE', getenv_docker('DEQAR_MEILIAPI_BASE', 'https://backend.sandbox.deqar.eu/meiliapi/v1/'));
define('DEQAR_API_KEY', getenv_docker('DEQAR_API_KEY'));
